...
export default function RootLayout() {
  ...
  useEffect(() => {
    initManusRuntime();
    // Configurar handler global para notificações em foreground
            ...
            <CartProvider>
              <NavigationController>
                <Stack screenOptions={{ headerShown: false }}>
                  ...
                  <Stack.Screen name="sale" options={{ animation: "slide_from_right" }} />
                  ...
                  <Stack.Screen name="stock-alerts" options={{ animation: "slide_from_right" }} />
